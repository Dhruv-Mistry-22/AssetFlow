...
export default async function DashboardPage() {
  ...
  const totalAssets = mockStats.totalAssets;
  const activeAllocations = mockStats.activeAllocations;
  const pendingMaintenance = mockStats.pendingMaintenance;
  const overdueReturns = mockStats.overdueReturns;
